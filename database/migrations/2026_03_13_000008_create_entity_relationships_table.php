...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('entity_relationships', function (Blueprint $table): void {
            ...
            $table->string('entity_a_type', 32)->comment('Morph type alias of the first entity');
            $table->uuid('entity_b_id')->comment('UUID of the second entity');
            $table->string('entity_b_type', 32)->comment('Morph type alias of the second entity');
            $table->string('relationship_type', 30)->comment('Type of relationship between entities');
            ...
            $table->unique(['entity_a_id', 'entity_a_type', 'entity_b_id', 'entity_b_type', 'relationship_type'], 'entity_rel_unique');
        });
    }
